 ...
 * every build.
 *
 * One row today. It is a group rather than a loose row because the strip is a
 * surface with more than one question to answer, and because a group that
 * exists is where the next such control lands instead of being parked wherever
 * looked closest.
 */
